...
/* Fim da sessão Nav Bar */

/* inicio da sessão heroi */
.hero {
	min-height: 80vh;
	width: 100%;
	padding-top: 50px;
...
/* Fm da sessão Serviços  */

/* inicio da sessão aqui  */
.hire {
	min-height: 10vh;
	flex-direction: column;
	width: 100%;
...
/* inicio mídia para área de trabalho  */
...
/* Fim mídia para área de trabalho  */

/* inicio mídia apenas para desktop  */
